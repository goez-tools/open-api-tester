...
class TestCase
{
     ...
     * @param array|string $response The received response content
     * @param string $format Format of the response content
     *
     * @return ValidationResult
     */
    public function validate(int $code, array|string $response, string $format = self::FORMAT_JSON): ValidationResult
    {
        $errors = [];
        $isValid = true;
